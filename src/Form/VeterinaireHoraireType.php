...
class VeterinaireHoraireType extends AbstractType
{
    private $container;
    private $security;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('jour', ChoiceType::class, [
            ...
            'attr' => [
                ...
                ->add('rdvUniquement', CheckboxType::class, [
                    'label' => 'Sur rendez-vous uniquement',
                    'label_attr' => [
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            'data_class' => VeterinaireHoraire::class,
        ]);
    }
